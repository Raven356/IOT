...
def connect_mqtt(broker, port):
    ...
    try:
        ...
        logger.error(
            f"Failed to connect to MQTT Server. Check connection or specify host and port via environment variables MQTT_BROKER_HOST and MQTT_BROKER_PORT."
        )
        exit(127)
    client.loop_start()
    return client
...
def run():
    ...
    # Prepare datasource
    datasource = FileDatasource("Accelerometer", "", "")
